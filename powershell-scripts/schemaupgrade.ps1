...
# Get all datasets configured in Enterprise Studio and perform a schema upgrade - Extra powershell paramters needed to stop TRIM Enterprise Studio loading after each command is called per dataset
